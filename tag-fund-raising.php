					...
					<div class="section-wrapper row">
						<div class="col-lg-8 col-12">
							<div class="blog-items">
								<!-- Add posts related to Fund Raising tag here -->
								<div class="post-item">
									<div class="post-item-inner">
										<div class="post-thumb">
											<a href="#"><img src="assets/img/blog/05.jpg" alt="blog"></a>
										</div>
										<div class="post-content">
											<div class="entry-header">
												<h6>Fund Raising</h6>
												<h5><a href="#">Supporting Physically Challenged Individuals</a></h5>
												<div class="entry-meta">
													<p class="posted-on">
														<i class="fas fa-calendar-alt"></i><a href="#">30 September 2023</a>
													</p>
													<p>
														<i class="fas fa-user-alt"></i><a href="#">John Doe</a>
													</p>
													<p class="cat-link">
														<a href="#"><i class="fa fa-comment"></i></a>8
													</p>
												</div>
