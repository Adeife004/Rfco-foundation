					...
					<div class="section-wrapper row">
						<div class="col-lg-8 col-12">
							<div class="blog-items">
								<!-- Add posts related to Children tag here -->
								<div class="post-item">
									<div class="post-item-inner">
										<div class="post-thumb">
											<a href="#"><img src="assets/img/blog/11.jpg" alt="blog"></a>
										</div>
										<div class="post-content">
											<div class="entry-header">
												...
												<div class="entry-meta">
													<p class="posted-on">
														<i class="fas fa-calendar-alt"></i><a href="#">15 October 2023</a>
													</p>
													<p>
														<i class="fas fa-user-alt"></i><a href="#">Jane Smith</a>
													</p>
													<p class="cat-link">
														<a href="#"><i class="fa fa-comment"></i></a>10
													</p>
												</div>
