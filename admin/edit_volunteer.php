...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$sql = "UPDATE volunteers SET first_name='$first_name', last_name='$last_name', email='$email', phone='$phone', interest='$interest', message='$message' WHERE id=$id";
		...
		<div class="container mt-5">
			...
			<form action="edit_volunteer.php" method="POST">
				...
				<div class="form-group">
					...
					<input type="text" name="interest" class="form-control" value="<?php echo $row['interest']; ?>" required>
				</div>
				<div class="form-group">
