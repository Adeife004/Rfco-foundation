					...
					<div class="section-wrapper row">
						<div class="col-lg-8 col-12">
							<div class="blog-items">
								<!-- Add posts related to Food tag here -->
								<div class="post-item">
									<div class="post-item-inner">
										<div class="post-thumb">
											<a href="#"><img src="assets/img/blog/07.jpg" alt="blog"></a>
										</div>
										<div class="post-content">
											<div class="entry-header">
												<h6>Food</h6>
												<h5><a href="#">Fresh Food for Children</a></h5>
												<div class="entry-meta">
													<p class="posted-on">
														<i class="fas fa-calendar-alt"></i><a href="#">20 August 2023</a>
													</p>
													<p>
														<i class="fas fa-user-alt"></i><a href="#">Jane Doe</a>
													</p>
													<p class="cat-link">
														<a href="#"><i class="fa fa-comment"></i></a>12
													</p>
												</div>
												<div class="entry-content">
													<p>Providing nutritious meals to children in need, ensuring they have the energy and health to thrive.</p>
