...
$fundraising_id = $_GET['id'];
$sql = "SELECT * FROM fundraising WHERE id = $fundraising_id";
...
<html lang="en">
	<head>
		...
		<title>Fundraising Confirmation</title>
		...
		<div class="container mt-5">
			<div class="card">
				<div class="card-header">
					<h3>Fundraising Confirmation</h3>
				</div>
				<div class="card-body">
					<p>Thank you, <strong><?php echo $row['first_name'] . ' ' . $row['last_name']; ?></strong>, for your interest in supporting the Rev. Fr. Callistus Osiaga Foundation.</p>
